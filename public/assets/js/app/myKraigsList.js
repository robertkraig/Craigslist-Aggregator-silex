var app = angular.module("myKraigsList", ['ngRoute', 'ngResource']);
...
app.controller('headerCtrlr',[ '$scope', '$location', 'Session', function($scope, $location, Session)
{
...
app.controller('pageCtrlr',['$scope','$http','Session',function($scope, $http, Session)
{
...
app.controller('myContentCtrlr',['$scope',function($scope)
{
